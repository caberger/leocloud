...
Wenn Sie Ihre email als Github Secret angegeben haben (siehe readme.md im k8s Verzeichnis), dann finden sie hier in der Dokumentation Ihre [deployment.yaml](./download/deployment.yaml) Datei.

Diese können Sie dann herunterladen und in die Cloud einspielen mit:
