...
Wenn Sie Ihre email als Github Secret angegeben haben (siehe readme.md im k8s Verzeichnis), dann können sie Ihre Anwendung mit folgender Anweisung in die Cloud einspielen:
